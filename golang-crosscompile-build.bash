...
printf " ---- Building BPM Spawner $versiond ---- \n"
printf "\n"
...
do
    ...
    arch=${split[1]}
    output=bpmSpawner
    package=goHornbillRequestBPMSpawner
    ...
    cp requests.csv "builds/$goos/$goarch/"
    ...
    zip -r "${package}_${os}_${arch}_v${version}.zip" $output *.md requests.csv > /dev/null
